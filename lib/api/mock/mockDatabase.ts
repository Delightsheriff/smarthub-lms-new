  ...
  conversations: [
    ...
    },
    {
      ...
      lastMessage: {
        ...
        content: "Just pushed my quiz app repo link.",
        createdAt: daysAgo(2),
      },
      unreadCount: { usr_1: 0 },
      updatedAt: daysAgo(2),
      metadata: {
        assignmentId: { _id: "asgn_2", title: "Interactive Quiz App" },
        courseId: { _id: "course_1", title: "Full-Stack Web Development", slug: "full-stack-web-development" },
        moduleId: { _id: "mod_2", title: "JavaScript Essentials", slug: "javascript-essentials" },
      },
    },
    {
      _id: "conv_3",
      ...
      participants: [
        mockUser,
        { _id: "usr_3", firstName: "Tunde", lastName: "Bakare", email: "tunde.bakare@example.com", role: "student" },
      ],
      lastMessage: {
        _id: "msg_12",
        conversationId: "conv_3",
        sender: { _id: "usr_3", firstName: "Tunde", lastName: "Bakare", email: "tunde.bakare@example.com" },
        content: "Are you working on the flexbox lab today?",
        createdAt: daysAgo(0),
      },
      unreadCount: { usr_1: 1 },
      updatedAt: daysAgo(0),
    ...
    },
    {
      ...
      participants: [
        ...
        mockInstructor,
        { _id: "usr_3", firstName: "Tunde", lastName: "Bakare", email: "tunde.bakare@example.com", role: "student" },
        { _id: "usr_4", firstName: "Aisha", lastName: "Bello", email: "aisha.bello@example.com", role: "student" },
      ],
      lastMessage: {
        _id: "msg_16",
        conversationId: "conv_4",
        sender: { _id: "usr_4", firstName: "Aisha", lastName: "Bello", email: "aisha.bello@example.com" },
        content: "Who has the link for today's office hours session?",
        createdAt: daysAgo(1),
      },
      unreadCount: { usr_1: 0 },
      updatedAt: daysAgo(1),
    ...
    },
    {
      ...
      lastMessage: {
        ...
        sender: { _id: "usr_2", firstName: "Ngozi", lastName: "Okonkwo", email: "ngozi.okonkwo@example.com" },
        content: "Submission window extended by 24h for capstone project.",
        createdAt: daysAgo(3),
      },
      unreadCount: { usr_1: 0 },
      updatedAt: daysAgo(3),
  ...
  messages: [
    {
      ...
      conversationId: "conv_1",
      sender: { _id: "usr_1", firstName: "Ade", lastName: "Balogun", email: mockUser.email },
      content: "Hello team, I submitted my assignment revision.",
      type: "text",
      createdAt: daysAgo(2),
    },
    {
    ...
    },
    {
      ...
      conversationId: "conv_2",
      sender: { _id: "usr_2", firstName: "Ngozi", lastName: "Okonkwo", email: "ngozi.okonkwo@example.com" },
      content: "Please ensure your quiz app handles state persistence correctly.",
      type: "text",
      createdAt: daysAgo(3),
    },
    {
      ...
      conversationId: "conv_2",
      sender: { _id: "usr_1", firstName: "Ade", lastName: "Balogun", email: mockUser.email },
      content: "Got it! Added localStorage sync for score progress.",
      type: "text",
      createdAt: daysAgo(2),
    },
    {
    ...
    },
    {
      ...
      conversationId: "conv_3",
      sender: { _id: "usr_1", firstName: "Ade", lastName: "Balogun", email: mockUser.email },
      content: "Hey Tunde, finished module 2 exercises?",
      type: "text",
      createdAt: daysAgo(1),
    },
    {
